...
// affichage du nombre de films chargÃ©s, devrait Ãªtre 247
console.log('Nombre de films :', movies.list().length);

// affichage d'un film, devrait Ãªtre "The god father"
console.log("Film d'indice 1 :", movies.read(1));

// affichage du film d'indice 42 dans la liste, devrait Ãªtre "The Pianist"
console.log("Film d'indice 42 dans la liste :", movies.list()[42]);

// crÃ©ation d'un nouveau film
...
console.log('Identifiant du film crÃ©Ã© :', id);

// devrait afficher le contenu du film prÃ©cÃ©demment ajoutÃ©
let movie = movies.read(id);
console.log("Film qui vient d'Ãªtre ajoutÃ© :", movie);

// mise Ã  jour du film, devrait afficher "true"
console.log("Mise Ã  jour du film :", movies.update(id, 'Parasite', 1982, movie.actors, movie.plot, movie.poster));

// mise Ã  jour d'un film qui n'existe pas, devrait afficher "false"
console.log("Mise Ã  jour du film (n'existe pas) :", movies.update(999, 'Parasite', 1982, movie.actors, movie.plot, movie.poster));
